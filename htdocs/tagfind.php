...
if ($q) 
{
   ...
   $size=1+$cnt+$cntopt;
   if ($size>15) $size=15;
   echo "<small><select size=$size onchange='document.getElementById(\"{$inputname}\").value=document.getElementById(\"{$inputname}\").value.substring(0,document.getElementById(\"{$inputname}\").value.lastIndexOf(\",\")+1);document.getElementById(\"{$inputname}\").value=document.getElementById(\"{$inputname}\").value+document.getElementById(\"{$inputname}_sel\").value+\",\";' onblur=document.getElementById(\"{$inputname}_sel\").style.display=\"none\" id='{$inputname}_sel' name='{$inputname}_sel' style='font-family: courier new;'>";
